...
class ChartPage extends StatefulWidget {
  ...
  const ChartPage({Key? key, this.showChart = true, this.division}) : super(key: key);
...
class _ChartPageState extends State<ChartPage> {
  ...
  initState() {
    ...
    chartController.getChartData(
        homeController.getDateStart(), homeController.getDateEnd(), division: widget.division);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          widget.showChart ? SizedBox(
            height: MediaQuery.of(context).size.height * 0.3,
            child: Obx(
              () =>  chartController.pieData.value.isNotEmpty
                  ? SfCircularChart(
          ...
          Expanded(
            child: Obx(() => chartController.pieData.value.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (index < chartColor.length) {
                        ...
                        if (chartController.percentageColor.value %
                                chartColor.length ==
                            0) {
                          chartController.percentageColor.value = 0;
                        }
                      ...
                      var color =
                          chartColor[chartController.percentageColor.value];
