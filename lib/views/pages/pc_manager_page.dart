  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        children:[
          Text("Try Inventory Manager with a web browser!", style: primaryTextStyleBold.copyWith(fontSize: 21)),
          const SizedBox(height: 12,),
          Obx(()=> pcManagerController.host.value != null ? Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children:[
              Text("Enter the following address to your browser:", style: primaryTextStyle),
          ...
          Obx(()=>ElevatedButton(
            ...
            child: Text(pcManagerController.host.value == null ? "Start" : "Stop"),
          ))
        ]
      )),
    );
